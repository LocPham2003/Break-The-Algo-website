...
const { userSignup, userSignin, userState, userSignout, userSignUpEvent, getUserListOfEvents, userDeregisterEvent, changePassword, getUserRole } = require('../controllers/userController')
